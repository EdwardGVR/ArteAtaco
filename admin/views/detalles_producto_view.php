    ...
    <main>
        ...
        <section class="productsAdmin">
            <div class="contenedor_productos">
                <?php $dispClass = ($producto['disponible'] == 0) ? "noDisp" : ""; ?>
                <div class="producto_list">
                    <form action="" class="info <?= $dispClass ?>" method="POST">
                        ...
                        <div class="field">
                            <?php   
                                $catName = ($producto['to_others'] == 1) ? $producto['nombre_cat'] . " (Actualmente en otros)" : $producto['nombre_cat'];
                                $catId = ($producto['to_others' != 1]) ? $producto['id_categoria'] : 1; 
                            ?>
                            
                            <a href="detallesCategoria.php?cat=<?= $catId ?>" class="label">
                                Categor&iacute;a
                            </a>
